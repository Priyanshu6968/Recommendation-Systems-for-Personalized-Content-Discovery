...
def main():
    ...
    print("Creating dense subset (top 2000 users, top 500 movies) to prevent RAM explosion...")
    ...
    models = {
        "Item-Based CF": SurpriseCFModel(user_based=False),
        "User-Based CF": SurpriseCFModel(user_based=True)
    }
